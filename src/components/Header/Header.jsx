...
import dashboard from '../../images/user.svg';
import logo from '../../images/logo.png';
import customers from '../../images/user.svg';
  ...
  return (
    <div className={css.header}>
      ...
      <div className={css.links}>
        ...
        <NavLink className={css.toLink} to="/product">
          Product
        </NavLink>
        <NavLink className={css.toLink} to="/customers">
          Customers
        </NavLink>
        <NavLink className={css.toLink} to="/income">
          Income
        </NavLink>
        <NavLink className={css.toLink} to="/promote">
          Promote
        </NavLink>
        <NavLink className={css.toLink} to="/help">
          Help
        </NavLink>
      </div>
    </div>
